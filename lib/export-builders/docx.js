...
async function buildDocxProfile(bundle, opts = {}) {
  ...
  if (wordFootnotes) {
    const r = await buildEndnotes(bundle.groups, bib, { markerAttr: true });
    ...
    prepared = await prepareCitations(bundle, { ...opts, bibliography: bib, scope: opts.scope || bundle.scope });
  }
