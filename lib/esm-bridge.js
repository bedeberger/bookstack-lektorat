...
// Diagramm-Notation (diagram/mermaid-html.js), das Tabellen-Markup
// (table/table-html.js). Der Server lädt sie per dynamic
...
const tableHtml    = () => esm('public/js/table/table-html.js');
